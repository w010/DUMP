...
/**
*
*	WARNING !!!! DON'T EDIT USING PHPSTORM - IT BREAKS LZW OUTPUT FROM THIS FILE SOMEHOW!
*
*	FILE MODIFIED! SEARCH FOR "wolo mod"
*   
*	(these changes are rather minor and not necessary to work with DUMP, but try to keep them when updating and transfer to the new one)
*
*/
...
page_footer($Re=""){
	...
	// wolo mod - fill empty space where lang selector is originally
	echo '<div id="lang"></div>';
	// end
	
global$b,$ni;echo'</div>
