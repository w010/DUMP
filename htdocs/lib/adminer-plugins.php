...
/**
 * DUMP add-on
 * Adminer plugins runner
 * 
 * Standard Adminer customization class for plugins support
 * 
 * 
 *      To minimize number of files here to minimum, keep plugins and the helper class stacked in one file 
 *
 *
